...
- [ ] T001 Create userspace directory structure at users/dario/
- [ ] T002 Create placeholder users/dario/dario.h with layer enums (BASE, NAV, MOUSE, MEDIA, NUM, SYM, FUN, BUTTON)
- [ ] T003 [P] Create placeholder users/dario/dario.c with empty process_record_user function
- [ ] T004 [P] Create users/dario/rules.mk with shared feature flags (MOUSEKEY_ENABLE, EXTRAKEY_ENABLE)
- [ ] T005 [P] Create scripts/generate_keymap_diagram.sh for visualization automation
- [ ] T006 [P] Create docs/keymaps/ directory for generated visualizations
- [ ] T007 Install keymap-drawer tool: python3 -m pip install --user keymap-drawer
...
- [ ] T027 [US5] Verify keyboards/boardsource/lulu/keymaps/dario/ already uses correct naming
- [ ] T028 [US5] Verify build command works: make boardsource/lulu/rp2040:dario

### Build Script Updates

- [ ] T029 [P] [US5] Create build_lily58.sh in repository root with correct keyboard path
- [ ] T030 [P] [US5] Create build_skeletyl.sh in repository root with correct keyboard path
- [ ] T031 [P] [US5] Verify build_lulu.sh exists and uses correct path

### Documentation Updates

- [ ] T032 [US5] Update KEYBOARDS.md to reflect all keymaps using "dario" naming
- [ ] T033 [US5] Update LULU_FLASHING_GUIDE.md if it references keymap names
- [ ] T034 [US5] Search for any other documentation files referencing old keymap names and update
